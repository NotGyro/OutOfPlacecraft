...
public class OOPCPacketHandler {
    ...
    public static final int SYNC_ALL_SKINS_MSG_ID = 2;
    ...
    public static void registerPackets() {
        ...
        INSTANCE.registerMessage(SYNC_ALL_SKINS_MSG_ID, SyncAllSkinsPkt.class, SyncAllSkinsPkt::encode, SyncAllSkinsPkt::decode, SyncAllSkinsPkt::handle);
    }
}
